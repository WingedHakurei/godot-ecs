...
1. **Direct Mode (`ECSSystem`)**: Similar to a plain class (RefCounted), supports a full lifecycle (Enter/Exit/Update), and allows systems to hold state. Suitable for UI, game flow, input control logic, etc.
